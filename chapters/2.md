...
![two way data binding + events](/images/chapters/2/01.png)
...
What's important isn't the specific cyclomatic complexity number. What's important is that, as you add more stuff to a page and increase the complexity, how does that number increase?
...
![08 global state](/images/chapters/2/01.png)
...
The cyclomatic complexity of any given thing on the page is, in most cases, reduced to two. And if there's a dependency chain there, other events you have to understand, there's an extremely formal, clear and explicit pathway to follow about and reason inside.
